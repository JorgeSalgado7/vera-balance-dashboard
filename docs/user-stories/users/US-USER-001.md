...
Un usuario puede tener el rol `clinic` o `therapist` y puede estar asociado a una clínica.

## Criterios de aceptación

### CA-01 - Crear usuario correctamente
...
cuando `name`, `email`, `password` o `professional_license` están vacíos,
...
### CA-05 - Protección de contraseña
...
### CA-07 - Asociación con clínica

Dado que se crea un usuario,
cuando se proporciona una clínica,
entonces debe almacenarse la referencia a la clínica correspondiente.

La asociación puede ser `null`.

### CA-08 - Estado inicial

Dado que se crea un nuevo usuario,
cuando el usuario es registrado,
entonces debe iniciar con estado `active`.

### CA-09 - Fechas de auditoría
...
* La asociación con una clínica puede ser `null`.
